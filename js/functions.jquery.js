...
document.addEventListener('DOMContentLoaded', function () {
  var parents = document.getElementsByClassName("parent-filter-child");
  for (var i = 0; i < parents.length; i++) {
    updateChild(parents.item(i));
  }
}, false);
...
function updateChild(t) {
  ...
  var parent_value = $(t).children("option:selected").val();
  var parent_name = $(t).attr("name");
