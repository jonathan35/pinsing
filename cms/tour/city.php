...
$keywordFields=array('city');
$filter = true;
$filFields = array('country');
...
$fields = array('id', 'country', 'state', 'city', 'position', 'status', 'seo_keyword', 'seo_description');
$value = array();
$type = array();
...
$fic_1 = array(0=>array(6, '2'));//fic = fiels in column, number of fields by column $fic_1 normally for add or edit template
...
$results = sql_read('select * from country where status=1 order by position ASC');
...
*/
$cols = $items =array();
$cols = array('Country' => 2, 'City' => 3, 'SEO Keyword' => 3, 'SEO Description' => 3, 'Position' => 1);//Column title and width
$items['Country'] = array('country');
$items['City'] = array('city');
