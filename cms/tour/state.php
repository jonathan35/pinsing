...
$fields = array('id', 'country', 'state', 'position', 'status', 'seo_keyword', 'seo_description');
$value = array();
$type = array();
...
*/
$cols = $items =array();
$cols = array('Country' => 2, 'State' => 3, 'SEO Keyword' => 3, 'SEO Description' => 3, 'Position' => 1);//Column title and width
$items['Country'] = array('country');
$items['State'] = array('state');
