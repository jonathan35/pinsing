...
$fields = array('id', 'country', 'photo', 'position', 'status', 'seo_keyword', 'seo_description');
$value = array();
$type = array();
...
*/
$cols = $items =array();
$cols = array('Country' => 2, 'Photo' => 3, 'SEO Keyword' => 3, 'SEO Description' => 3, 'Position' => 1);//Column title and width
