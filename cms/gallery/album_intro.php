...
$table = 'album_intro';
$module_name = 'Gallery Introduction';
$php = 'album_intro';
...
$fields = array('id', 'introduction', 'background_image');
$value = array();
$type = array();
...
$attributes['album_intro'] = array('required' => 'required');
...
$remark['background_image'] = '<div><small class="text-muted" >Recommanded size: 1920 x 1000 pixel</small></div>';
...
*/
$cols = $items =array();
$cols = array('Photo' => 6, 'Introduction' => 6);//Column title and width
$items['Introduction'] = array('album_intro');
$items['Photo'] = array('background_image');
