	...
	<div class="modal-dialog" role="document" style="width: 800px !important;">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="media-opt" onclick="addTinyEditor();">Text Editor</div>
				...
				<div class="p-2">
					...
					<div class="media media5">
						<div class="pb-2 mb-3" style="border-bottom:1px solid #999;">
							...
							<div class="pt-2 text-muted">Internal link eg.: /contact-us  (refer website URL)</div>
							<div class="text-muted">External link eg.: //hoteline.travel</div>
						</div>
